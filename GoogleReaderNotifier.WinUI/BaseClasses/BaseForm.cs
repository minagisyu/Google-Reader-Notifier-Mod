...
//					this.Height = this.windowHeight;
		...
		private void OnMenuRestoreDrawItem(object sender, DrawItemEventArgs e)
		{
			...
			drawMenuItem(item, e);
			drawMenuIcon("delistore.restore.png", e);
		}
		...
		#region OnMenuMinimizeClick

		private void OnMenuMinimizeClick(object sender, EventArgs e)
		{
			this.WindowState = FormWindowState.Minimized;
		}
		...
		private void OnMenuMaximizeDrawItem(object sender, DrawItemEventArgs e)
		{
			...
			drawMenuItem(item, e);
			drawMenuIcon("delistore.maximize.png", e);
		}
		#endregion
		...
		private void OnMenuCloseDrawItem(object sender, DrawItemEventArgs e)
		{
			...
			drawMenuItem(item, e);
			drawMenuIcon("delistore.close.png", e);
		}
...
//			item.MeasureItem +=new MeasureItemEventHandler(OnMenuMeasureItem);
			...
			item.Text = "Minimize";
			item.Enabled = false;
			item.Click += new EventHandler(OnMenuMinimizeClick);
			menu.MenuItems.Add(item);
